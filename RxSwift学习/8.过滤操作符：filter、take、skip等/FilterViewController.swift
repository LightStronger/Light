...
class FilterViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        /*
         5、ignoreElements
         (1) 基本介绍
         .该操作符可以忽略掉所有的元素，只发出error或completed事件
         .如果我们并不关心Observable的任何元素，只想知道Observable在什么时候终止，那就可以使用ignoreElementsz操作符
         */
        Observable.of(1,2,3,4)
            .ignoreElements()
            .subscribe {
        ...
        /*
         ...
         自己认为 skip(2)跳过前两个 剩下3，4，所以只打印3，4
         */
        Observable.of(1,2,3,4)
            .skip(2)
            .subscribe(onNext: { print($0) })
        ...
        /*
         10、debounce
         (1) 基本介绍
         .denounce操作符可以用来过滤掉高频产生的元素，它会发出这种元素：一段时间内没有新元素产生
